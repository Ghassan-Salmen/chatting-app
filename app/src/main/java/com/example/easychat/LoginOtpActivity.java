    ...
    void sendOtp(String phoneNumber, boolean isResend){
        ...
        PhoneAuthOptions.Builder builder =
                PhoneAuthOptions.newBuilder(mAuth)
                        ...
                        .setTimeout(timeoutSeconds, TimeUnit.SECONDS)//time for verification process
                        .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            @Override
                            //Called when the verification is completed automatically
                            ...
                            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                ...
                                verficationCode = s;//OTP sent to the user
                                resendingToken = forceResendingToken;// token that allows you to resend the verification code to the same phone number
